...
public class SearchPanel extends JPanel {
    ...
    private void initButton(){
        btn_search = new JButton(new ImageIcon(cl.getResource("images/icons/search.png")));
    ...
    private void initTextField(){
        txt_search = new HintTextField("mot-clé", new Color(44, 74, 171), new Color(255, 255, 255));
        ...
        txt_search.setBackground(new Color(102, 255, 0));
    }
